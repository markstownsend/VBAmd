...
let githubLink = "http://github.com/markstownsend/VbaMd"

// Specify more information about your project
let info =
  [ "project-name", "VbaMd"
    "project-author", "Mark Townsend"
    "project-summary", "Extracts markdown from your VBA source files."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/VbaMd" ]
